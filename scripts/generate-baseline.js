...
function convertTemplateFile(filePath) {
  ...
  const rule = {
    ...
    why: "Onderdeel van de tussen beheerder en klant afgesproken CA-baseline (bron: CA-Policies/CATemplate). Groepsuitsluitingen tellen mee (op naam, na resolutie in de klanttenant); individuele gebruikersuitsluitingen bewust niet — dat is per klant een eigen invulling.",
